...
{
    public class MemberIsRegisteredAttribute : ActionFilterAttribute
    {
        public override async Task OnActionExecutionAsync(ActionExecutingContext context, ActionExecutionDelegate next)
        {
            ...
            if(result == OperationErrorMessages.NoError && !(member as MemberAPI_GetProfile_DTO).IsRegistered)
            {
                context.Result = ResultResponceExtension.ObjectResultResponse<object>(OperationErrorMessages.MemberIsNotRegistered);
            }
